    ...
    <div id="content-container">
        <div id="content" class="clearfix">
            <div id="main-content" <?php if (get_option('sf_sidebar') =='Left'): echo "class=\"alignright\""; endif; ?>>
				...
				<h1 id="main-title"><span><?php printf( __( 'Search Results for: %s', 'greenwork' ), '<span>' . get_search_query() . '</span>' ); ?></h1>	
				</article>			
     		...
     		while (have_posts()) : the_post();
				...
				?>
					...
					<?php $x++; endwhile; ?>
					<?php else:?>
			<p><?php _e( 'Sorry, but nothing matched your search criteria. Please try again with some different keywords.', 'schoolfun' ); ?></p>
			<?php get_search_form();
			endif;?>
                </div>                                
